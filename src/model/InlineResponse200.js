...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S4sFull.InlineResponse200 = factory(root.S4sFull.ApiClient, root.S4sFull.PaymentRequest);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [PaymentRequest]);
      }
  ...
  /**
   * @member {Array.<module:model/PaymentRequest>} data
   */
