...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S4sFull.ResourceStatus = factory(root.S4sFull.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('spend')) {
        obj['spend'] = ApiClient.convertToType(data['spend'], 'Integer');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Integer} spend
   */
  exports.prototype['spend'] = undefined;
