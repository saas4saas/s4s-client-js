...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S4sFull.InlineResponse2005 = factory(root.S4sFull.ApiClient, root.S4sFull.ResourceStatus);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [ResourceStatus]);
      }
  ...
  /**
   * @member {Array.<module:model/ResourceStatus>} data
   */
