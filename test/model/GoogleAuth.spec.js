...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S4sFull.GoogleAuth();
  });
  ...
  describe('GoogleAuth', function() {
    it('should create an instance of GoogleAuth', function() {
      // uncomment below and update the code to test GoogleAuth
      //var instane = new S4sFull.GoogleAuth();
      //expect(instance).to.be.a(S4sFull.GoogleAuth);
    });
