...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S4sFull.CustomerInfo();
  });
  ...
  describe('CustomerInfo', function() {
    it('should create an instance of CustomerInfo', function() {
      ...
      //var instane = new S4sFull.CustomerInfo();
      //expect(instance).to.be.a(S4sFull.CustomerInfo);
    });
    ...
    it('should have the property paymentConf (base name: "paymentConf")', function() {
      // uncomment below and update the code to test the property paymentConf
      //var instane = new S4sFull.CustomerInfo();
      //expect(instance).to.be();
    });
