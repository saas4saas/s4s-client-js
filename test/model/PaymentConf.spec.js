...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S4sFull.PaymentConf();
  });
  ...
  describe('PaymentConf', function() {
    it('should create an instance of PaymentConf', function() {
      // uncomment below and update the code to test PaymentConf
      //var instane = new S4sFull.PaymentConf();
      //expect(instance).to.be.a(S4sFull.PaymentConf);
    });
