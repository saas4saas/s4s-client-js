...
(function(root, factory) {
  ...
  describe('S4sError', function() {
    it('should create an instance of S4sError', function() {
      // uncomment below and update the code to test S4sError
      //var instane = new S4sFull.S4sError();
      //expect(instance).to.be.a(S4sFull.S4sError);
    });
