...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S4sFull.PricingUiConfPack();
  });
  ...
  describe('PricingUiConfPack', function() {
    it('should create an instance of PricingUiConfPack', function() {
      // uncomment below and update the code to test PricingUiConfPack
      //var instane = new S4sFull.PricingUiConfPack();
      //expect(instance).to.be.a(S4sFull.PricingUiConfPack);
    });
