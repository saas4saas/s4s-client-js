...
(function(root, factory) {
  ...
  describe('UtUser', function() {
    it('should create an instance of UtUser', function() {
      // uncomment below and update the code to test UtUser
      //var instane = new S4sFull.UtUser();
      //expect(instance).to.be.a(S4sFull.UtUser);
    });
