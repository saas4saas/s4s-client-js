...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S4sFull.PricingConf();
  });
  ...
  describe('PricingConf', function() {
    it('should create an instance of PricingConf', function() {
      // uncomment below and update the code to test PricingConf
      //var instane = new S4sFull.PricingConf();
      //expect(instance).to.be.a(S4sFull.PricingConf);
    });
