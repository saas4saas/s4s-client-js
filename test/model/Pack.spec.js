...
(function(root, factory) {
  ...
  describe('Pack', function() {
    it('should create an instance of Pack', function() {
      ...
      //var instane = new S4sFull.Pack();
      //expect(instance).to.be.a(S4sFull.Pack);
    });
    ...
    it('should have the property subscriptible (base name: "subscriptible")', function() {
      // uncomment below and update the code to test the property subscriptible
      //var instane = new S4sFull.Pack();
      //expect(instance).to.be();
    });
