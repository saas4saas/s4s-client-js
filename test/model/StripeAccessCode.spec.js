...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S4sFull.StripeAccessCode();
  });
  ...
  describe('StripeAccessCode', function() {
    it('should create an instance of StripeAccessCode', function() {
      // uncomment below and update the code to test StripeAccessCode
      //var instane = new S4sFull.StripeAccessCode();
      //expect(instance).to.be.a(S4sFull.StripeAccessCode);
    });
    ...
    it('should have the property stripePublishableKey (base name: "stripe_publishable_key")', function() {
